...
LeRobot是由Hugging Face开发的一个基于 PyTorch 的机器人学习框架，集成了整个机器人学习的技术栈，提供了一个良好的机器人学习平台。LeRobot参考[原始代码](https://github.com/2toinf/X-VLA)实现了X-VLA。本文根据huggingface/lerobot仓库中的代码快速浏览X-VLA的部分实现。

## 基础环境与文件结构

Ubunutu 24.04 + nvidia-driver-570 + prime-select on-demand + torch 2.10.0 cu128 + RTX5060 环境可用。
